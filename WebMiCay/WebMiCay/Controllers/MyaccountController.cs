...
namespace WebMiCay.Controllers
{
    public class MyaccountController : Controller
    {
        ...
        {
            string maKhachHang = "";
            // Kiểm tra xem Session có tồn tại và có là đối tượng ClientViewModel không
            if (Session["user"] != null)
            {
                // Sử dụng user.MaKH ở đây
                var user = Session["user"] as WebMiCay.Models.ClientViewModel;
        ...
        public ActionResult Account(string TenKH, string SDT, DateTime? NgaySinh, string DiaChi, string GioiTinh, string MatKhauKhach)
        {
            ...
            var user = Session["user"] as ClientViewModel;
            ...
            if (user != null)
            {
                ...
                if (khachHang != null && taiKhoanKhach != null)
                {
                    ...
                    user = new ClientViewModel
                    {
                        ...
                        MaTaiKhoanKhach = taiKhoanKhach.MaTaiKhoanKhach,
                        TenTaiKhoanKhach = taiKhoanKhach.TenTaiKhoanKhach,
                        MatKhauKhach = taiKhoanKhach.MatKhauKhach,
                        NgayTao = taiKhoanKhach.NgayTao
                    };
                    Session["user"] = user;
